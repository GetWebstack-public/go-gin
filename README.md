...
A REST API example built with [Gin](https://gin-gonic.com/) — a fast HTTP web framework for Go featuring a martini-like API with up to 40x better performance.
...
```bash
git clone https://github.com/GetWebstack-public/go-gin
cd go-gin
```
